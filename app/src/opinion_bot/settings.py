"""
Django settings for opinion_bot project.
"""
...
ROOT_URLCONF = "opinion_bot.urls"

TEMPLATES = [
    {
        "BACKEND": "django.template.backends.django.DjangoTemplates",
        "DIRS": [root("opinion_bot/templates")],
        "APP_DIRS": True,
        "OPTIONS": {
            "context_processors": [
...
WSGI_APPLICATION = "opinion_bot.wsgi.application"
ASGI_APPLICATION = "opinion_bot.asgi.application"
...
REST_FRAMEWORK = {
    ...
    "DEFAULT_PAGINATION_CLASS": "opinion_bot.api.pagination.CursorPagination",
    "PAGE_SIZE": 20,
...
CELERY_BEAT_SCHEDULE = {  # type: ignore
    # 'task_name': {
    #     'task': "opinion_bot.opinion_bot.tasks.demo_task",
    #     'args': [2, 2],
    #     'kwargs': {},
...
DISCORD_BOT_METRICS_PORT = env.int("DISCORD_BOT_METRICS_PORT")
